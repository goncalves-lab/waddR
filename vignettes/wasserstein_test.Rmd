...
spec.output <- c(   "pval", "d.wass^2", "perc.loc",
...
set.seed(24)
dd1 <- rnorm(300, 1, 1)
wasserstein.test(ctrl, dd1, permnum=10000, method="SP")[spec.output]
...
set.seed(24)
dd2 <- rnorm(300, 0, 2)
wasserstein.test(ctrl, dd2, permnum=10000, method="SP")[spec.output]
...
wasserstein.test(ctrl, dd3, permnum=10000, method="SP")[spec.output]
...
set.seed(24)
nodd <- rnorm(300, 0, 1)
wasserstein.test(ctrl, nodd, permnum=10000, method="SP")[spec.output]
