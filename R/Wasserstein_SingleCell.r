...
## apply semi-parametric Wasserstein test; either include zero expression
## values (one-stage approach) or not (two-stage approach with separate test
## for differential proportions of zeroes)
