...
RcppExport SEXP _diffexpR_mean(SEXP xSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _diffexpR_abs(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
// cumSum
NumericVector cumSum(NumericVector x, const int last_index);
RcppExport SEXP _diffexpR_cumSum(SEXP xSEXP, SEXP last_indexSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
    Rcpp::traits::input_parameter< const int >::type last_index(last_indexSEXP);
    rcpp_result_gen = Rcpp::wrap(cumSum(x, last_index));
    return rcpp_result_gen;
END_RCPP
}
// rep_weighted
...
RcppExport SEXP _diffexpR_concat(SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
